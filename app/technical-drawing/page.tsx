...
const focusAreas = [
  "Orthographic view interpretation",
  "Projection direction selection",
  "Surface-to-view correspondence",
  "Stepwise isometric construction",
];
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <p className="mt-4 text-lg font-medium text-accent/80">
                Interactive orthographic and 3D visualization tools
              </p>
            </div>
            <div className="text-accent">
              <TopicIcon name="technical-drawing" className="h-20 w-20 sm:h-24 sm:w-24" />
            </div>
          </div>
