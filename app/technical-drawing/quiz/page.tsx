...
import { TechnicalDrawingModuleQuiz } from "@/components/simulations/TechnicalDrawingModuleQuiz";
import { PathStepNav } from "@/components/path/PathStepNav";
import { getPathForHref } from "@/lib/paths";

const CURRENT_HREF = "/technical-drawing/quiz";

export default function TechnicalDrawingQuizPage() {
